...
function fetchUcapan() {
  var url = 'https://script.google.com/macros/s/AKfycbyTMBsH0IeHpAYxuVsPzE66GS_-nZuIaf0la3EcTyGZmWZr4FZ6CD0djET9fosieQ5d/exec'; // Ganti dengan URL Web App Google Apps Script Anda
...
document.getElementById('formPernikahan').addEventListener('submit', function(event) {
  ...
  fetch('https://script.google.com/macros/s/AKfycbyTMBsH0IeHpAYxuVsPzE66GS_-nZuIaf0la3EcTyGZmWZr4FZ6CD0djET9fosieQ5d/exec', {
    method: 'POST',
